...
`).map((e,n)=>e.startsWith("## ")?a.jsx("h2",{style:{fontFamily:"Urbanist, sans-serif",fontWeight:900,fontSize:17,color:"var(--text-primary)",margin:"16px 0 8px"},children:e.slice(3)},n):e.startsWith("### ")?a.jsx("h3",{style:{fontFamily:"Urbanist, sans-serif",fontWeight:800,fontSize:15,color:"var(--text-primary)",margin:"14px 0 6px"},children:e.slice(4)},n):e.startsWith("- ")||e.startsWith("• ")?a.jsxs("div",{style:{display:"flex",gap:8,marginBottom:3},children:[a.jsx("span",{style:{color:"var(--purple-primary)",fontWeight:700,flexShrink:0},children:"•"}),a.jsx("span",{dangerouslySetInnerHTML:{__html:e.slice(2).replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>")}})]},n):e.trim()===""?a.jsx("div",{style:{height:6}},n):a.jsx("p",{style:{margin:"2px 0"},dangerouslySetInnerHTML:{__html:e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>")}},n))})}function Nn({title:t,subtitle:e,onBack:n}){return a.jsxs("div",{style:{display:"flex",alignItems:"center",gap:14,marginBottom:28},children:[a.jsx(r4,{onClick:n}),a.jsxs("div",{children:[a.jsx("h2",{style:{fontFamily:"Urbanist, sans-serif",fontWeight:900,fontSize:22,color:"var(--text-primary)",lineHeight:1.2},children:t}),e&&a.jsx("p",{style:{fontSize:13,color:"var(--text-muted)",marginTop:2},children:e})]})]})}function i4({onBack:t}){const[e,n]=M.useState("setup"),[r,i]=M.useState({company:"",dept:"",role:"",level:"Fresher (0 exp)"}),[s,o]=M.useState([]),[c,u]=M.useState([]),[d,f]=M.useState(""),[g,m]=M.useState(0),[S,A]=M.useState(""),[j,O]=M.useState(!1),[E,v]=M.useState(""),[b,P]=M.useState(!1),L=M.useRef(null);M.useEffect(()=>{var T;(T=L.current)==null||T.scrollIntoView({behavior:"smooth"})},[s,j]);const R=`You are an interview preparation coach. You are running a ${Wt}-question diagnostic quiz for a ${r.level} candidate preparing for ${r.company} interview for the role of ${r.role} (${r.dept} branch).
